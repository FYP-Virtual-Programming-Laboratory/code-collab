...
export type GetFileHistoryQuery = { __typename?: 'Query', getFileVersions: Array<{ __typename?: 'Version', id: number, createdAt: any, committedBy: string, snapshot: string }> };
